						...
						<div class="form-group">
							...
							<div class="input-group">
								<span class="input-group-addon">Nome</span> <input
									class="form-control" type="text" id="titulo-"><span
								...
								<tbody id="tabela-fisicos">
									<c:forEach items="${clienteFisicos}" var="clientesFisicos">
										<tr>
											...
											<td><a
												href='/ProjetoFinal_Livraria/editarClienteFisico?cpf=${clienteFisico.getCpf()}'>Editar</a></td>
											<td><a href="" class="delete-link"
												id='${clienteFisico.getCpf()}'>Excluir</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>

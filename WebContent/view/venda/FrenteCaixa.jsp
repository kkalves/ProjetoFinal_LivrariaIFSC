	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<div class="page-title">
				<div>
					<h1>
						<i class="fa fa-edit"></i>Frente Caixa
					</h1>
					<p>Caixa</p>
				</div>
				<div>
							...
							<form>
								<div class="form-group">
									<label class="control-label">Produto:</label> <input
										class="form-control" id="titulo-produto" name="produto">
								</div>
								<div class="form-group">
									<button type="button" id="btn-buscar" name="btn_buscar"
										class="btn btn-primary">Buscar</button>
								</div>
								<div class="form-group">
									<label class="control-label">Descrição Produto:</label>
									<textarea class="form-control" id="descricaoProduto"
										name="descricaoProduto" rows="4"></textarea>
								</div>
								<div class="form-group">
									<label class="control-label">Valor Unitario:</label> <input
										class="form-control" id="valorUnitario" name="valorUnitario">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="input-group">
										<span class="input-group-addon">%</span> <input
											class="form-control" id="valorDesconto" name="valorDesconto"
											type="text"> <span class="input-group-btn">
											<button class="btn btn-primary" id="btn-desconto"
								...
								<div class="form-group">
									<label class="control-label">Valor Total:</label> <input
										class="form-control" id="valorTotal" name="valorTotal">
								</div>
								<div class="form-group">
									<button class="btn btn-primary" id="btn-add" type="button">
										Adicionar ao carrinho<span class="fa fa-cart-plus"></span>
									</button>
								</div>
							</form>
						</div>

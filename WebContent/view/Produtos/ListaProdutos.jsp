			...
			<div class="page-title">
				...
				<div>
					<a class="btn btn-primary btn-flat"
						href="/ProjetoFinal_Livraria/CadastroProduto"><i
					...
					<div class="card">
						<div class="form-group">
							...
							<div class="input-group">
								<span class="input-group-addon">Título</span> <input
								...
								<tbody id="tabela-produtos">
									<c:forEach items="${produtos}" var="produto">
										<tr>
											...
											<td><a
												href='/ProjetoFinal_Livraria/editarProduto?isbn=${produto.getIsbn()}'>Editar</a></td>
											<td><a href="" class="delete-link"
												id='${produto.getIsbn()}'>Excluir</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>

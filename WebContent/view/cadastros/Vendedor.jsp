    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-edit"></i>Cadastro Vendedor</h1>
            <p></p>
          </div>
          <div>
            <ul class="breadcrumb">
              ...
              <li>Formulario</li>
              <li><a href="#">Cadastro Vendedor</a></li>
            </ul>
          </div>
        </div>
        <div class="row">
              ...
              <div class="card-body">
                <form>
                  <div class="form-group">
                    <label class="control-label">Nome funcionario</label>
                    <input class="form-control" name="nome" placeholder="Digite o nome completo do funcionario ">
                  </div>
                  <div class="form-group">
                    <label class="control-label">Email</label>
                    <input class="form-control" name="email" placeholder="Email do funcionario ">
                  </div>
                  <div class="controls">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" name="cpf" placeholder="CPF do funcionario">
                  </div>
                  <div class="form-group">
                    <label class="control-label">Endereço</label>
                    <input class="form-control" name="endereço" placeholder="Endereço do funcionario">
                  </div>
                  <div class="form-group">
                    <label class="control-label">Bairro</label>
                    <input class="form-control" name="bairro" placeholder="Bairro do funcionario">
                  </div>
                  <div class="form-group">
                    <label class="control-label">Telefone</label>
                    <input class="form-control" name="telefone" placeholder="Telefone do funcionario">
                  </div>
                   <div class="form-group">
                    <label class="control-label">Cidade</label>
                    <input class="form-control" name="cidade" placeholder="Cidade do funcionario">
                  </div>
                   <div class="form-group">
                    <label class="control-label">Estado</label>
                    <input class="form-control" name="estado" placeholder="Estado do funcionario">
                             
            <hr>
            <div class="form-group">
                <label for="estado">Usuario</label><br />
               <input class="form-control" name="usuario" placeholder="Usuario" size="20" >
              
            </div>
            <div class="form-group"></div>
                <label for="estado">Senha</label><br />
               <input class="form-control" name="senha" placeholder="Senha" size="20" > 
            </div>
          <div class="form-group"></div>
                <label for="estado">Confirmar Senha</label><br />
                <input class="form-control" name="senha" placeholder="Senha" size="20" >

	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<div class="page-title">
				<div>
					<h1>
						<i class="fa fa-edit"></i>Cadastro Vendedor
					</h1>
					<p></p>
				</div>
				<div>
						...
						<div class="card-body">
							<form>
								<div class="form-group">
									<label class="control-label">Nome funcionario</label> <input
										class="form-control" name="nome"
										placeholder="Digite o nome completo do funcionario ">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label class="control-label">Endereço</label> <input
										...
										placeholder="Endereço do funcionario">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label class="control-label">Cidade</label> <input
										...
										placeholder="Cidade do funcionario">
								</div>
								<div class="form-group">
									...
									<hr>
									<div class="form-group">
										<label for="estado">Usuario</label><br /> <input
											class="form-control" name="usuario" placeholder="Usuario"
											size="20">

									</div>
									<div class="form-group"></div>
									<label for="estado">Senha</label><br /> <input
										class="form-control" name="senha" placeholder="Senha"
										size="20">
								</div>
								<div class="form-group"></div>
								<label for="estado">Confirmar Senha</label><br /> <input
									class="form-control" name="senha" placeholder="Senha" size="20">
						</div>
						</form>
					</div>
